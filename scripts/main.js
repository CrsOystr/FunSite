...
var Bubble = (function () {
    ...
    Bubble.prototype.ageMe = function () {
        this.age++;
    };
    return Bubble;
}());
var Runner = (function () {
    ...
    Runner.prototype.run = function (progress) {
    ...
    Runner.prototype.changeDirection = function () {
...
function draw() {
    ...
    var floorw = canvas.width + (50 - canvas.width % 50);
    var floorh = canvas.height + (50 - canvas.height % 50);
    var numbx = (floorw) / 50;
    var numby = (floorh) / 50;
